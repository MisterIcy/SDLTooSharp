...
public static partial class SDL
{
    ...
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_BITSIZE">SDL2 Documentation</a></remarks>
    public static byte SDL_AUDIO_BITSIZE(ushort x)
    {
        return (byte)( x & SDL_AUDIO_MASK_BITSIZE );
    }
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISFLOAT">SDL2 Documentation</a></remarks>
    public static bool SDL_AUDIO_ISFLOAT(ushort x) => ( x & SDL_AUDIO_MASK_DATATYPE ) == SDL_AUDIO_MASK_DATATYPE;
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISINT">SDL2 Documentation</a></remarks>
    public static bool SDL_AUDIO_ISINT(ushort x) => !SDL_AUDIO_ISFLOAT(x);
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISBIGENDIAN">SDL2 Documentation</a></remarks>
    public static bool SDL_AUDIO_ISBIGENDIAN(ushort x) => ( x & SDL_AUDIO_MASK_ENDIAN ) == SDL_AUDIO_MASK_ENDIAN;
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISLITTLEENDIAN">SDL2 Documentation</a></remarks>
    public static bool SDL_AUDIO_ISLITTLEENDIAN(ushort x) => !SDL_AUDIO_ISBIGENDIAN(x);
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISSIGNED">SDL2 Documentation</a></remarks>
    public static bool SDL_AUDIO_ISSIGNED(ushort x) => ( x & SDL_AUDIO_MASK_SIGNED ) == SDL_AUDIO_MASK_SIGNED;
    ///<summary></summary>
    ///<remarks><a href="https://wiki.libsdl.org/SDL2/SDL_AUDIO_ISUNSIGNED">SDL2 Documentation</a></remarks>
