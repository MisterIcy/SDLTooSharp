...
/// <summary>
/// Event args for when a display is connected into the system.
/// </summary>
[AcceptableDisplayEvent(SDL.SDL_DisplayEventID.SDL_DISPLAYEVENT_CONNECTED)]
public sealed class DisplayConnectedEventArgs : AbstractDisplayEventArgs
{
    /// <summary>
    /// Creates a new DisplayConnectedEventArgs object
    /// </summary>
    ...
    public DisplayConnectedEventArgs(SDL.SDL_Event evt) : base(evt)
    {
    }
}
